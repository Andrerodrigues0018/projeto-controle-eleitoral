...
<html>
    ...
    <body>
        <script>
            $(document).ready(function(){
                $('#botao').on('click', function(){
                    $.ajax({
                        url: 'http://localhost:8080/ex_02_ajax_json/usuario_controller',
                        
                        success: function(data){
                            $('#saida').html("Nome de usuário: " +
                                              data.nomeUsuario + 
                                              "<br/> Senha: " + 
                                              data.senha);
                        }
        ...
        <article class="generic-se-ma">
            ...
            <p> Saudações eleitor! Bem Vindo ao sistema de controle eleitoral da ETEC, com ele
