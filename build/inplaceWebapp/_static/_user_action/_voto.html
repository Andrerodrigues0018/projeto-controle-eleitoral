...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="generic-se-ma" style="text-align: justify" >
            ...
            <p>Candidatos:<b> Tiririca,Tiririca, Tirica</b></p>
            <p>Registro de Matricula: <?php echo$_COOKIE['rm_escolar'];?></p>
        ...
        <section class="generic-se-ma">
            ...
            <a href="_incluir_voto.php">  <button style="background-color: #1ba46a;" class="fa fa-print"> 
                    <span> &nbsp; Imprimir e confirmar o voto </span></button></a>
