...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <article class="generic-se-ma" 
            ...
            <h2>O que é o sistema de controle eleitoral?</h2>
            
            <p> Este sistema é dedicado á realização de votos eleitorais de forma
            online e totalmente automática. Com ele, você pode consultar quais são os candidatos 
            e suas propostas através de uma página que pode ser acessada no menu lateral (primeiro botão),
            logo em seguida, através da entrada do seu RM escolar realizar o seu voto (segundo botão) de maneira prática
             e rápida. Caso tiver dúvidas, visite a página de Tire dúvidas (terceito botão).</p>
